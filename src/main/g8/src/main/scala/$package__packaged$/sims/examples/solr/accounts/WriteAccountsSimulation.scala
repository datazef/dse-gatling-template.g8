package $organization$.$name$.sims.examples.solr.accounts

import $organization$.$name$.actions.examples.solr.AccountActions
import com.datastax.gatling.plugin.CqlPredef._
import com.datastax.gatling.stress.core.BaseSimulation
import com.datastax.gatling.stress.libs.SimConfig
import $organization$.$name$.feeds.examples.solr.AccountFeed
