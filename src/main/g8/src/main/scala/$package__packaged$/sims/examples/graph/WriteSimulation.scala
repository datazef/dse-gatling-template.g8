package $organization$.$name$.sims.examples.graph

import $organization$.$name$.actions.examples.graph.GraphActions
import com.datastax.gatling.plugin.GraphPredef._
import com.datastax.gatling.stress.core.BaseSimulation
import com.datastax.gatling.stress.libs.SimConfig
import $organization$.$name$.feeds.examples.graph.GraphFeed
