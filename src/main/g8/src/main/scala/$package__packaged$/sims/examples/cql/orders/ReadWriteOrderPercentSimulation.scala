package $organization$.$name$.sims.examples.cql.orders

import $organization$.$name$.actions.examples.cql.OrderActions
import com.datastax.gatling.plugin.CqlPredef._
import com.datastax.gatling.stress.core.BaseSimulation
import com.datastax.gatling.stress.libs.{FetchBaseData, SimConfig}
import $organization$.$name$.feeds.examples.cql.OrderFeed
