package $organization$.$name$.sims.examples.cql.urls

import $organization$.$name$.actions.examples.cql.UrlActions
import com.datastax.gatling.plugin.CqlPredef._
import com.datastax.gatling.stress.core.BaseSimulation
import com.datastax.gatling.stress.libs.SimConfig
import $organization$.$name$.feeds.examples.cql.UrlFeed
