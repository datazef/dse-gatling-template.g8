package $organization$.$name$.sims.examples.cql.members

import $organization$.$name$.actions.examples.cql.MemberActions
import com.datastax.gatling.plugin.CqlPredef._
import com.datastax.gatling.stress.core.BaseSimulation
import com.datastax.gatling.stress.libs.SimConfig
import $organization$.$name$.feeds.examples.cql.MemberFeed
